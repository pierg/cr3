...
from logic.specification import Cnf, Dnf, Specification
from logic.specification.boolean import Bool
from logic.specification.temporal.tools import transform_spot_tree
from logic.specification.tools import is_true_string
from logic.specification.trees import (
    boolean_tree_to_formula,
    extract_atoms_dictionary,
    gen_atoms_tree,
    gen_ltl_tree,
)
from logic.tools.atomic_propositions import extract_ap
from logic.tools.nuxmv import check_satisfiability, check_validity
from logic.typelement.basic import (
    Boolean,
    BooleanControllable,
    BooleanUncontrollable,
)
from logic.typelement.robotic import BooleanLocation, BooleanSensor
...
class LTL(Specification):
    ...
    def adjacency_rules(self) -> LTL:
        from logic.specification.rules_extractors import extract_adjacency_rules

        return extract_adjacency_rules(self.typeset)

    @property
    def mutex_rules(self) -> LTL:
        from logic.specification.rules_extractors import extract_mutex_rules

        return extract_mutex_rules(self.typeset)

    @property
    def refinement_rules(self) -> LTL:
        from logic.specification.rules_extractors import extract_refinement_rules

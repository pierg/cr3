from goals.case_studies.minimal.world.world_ref import w_ref
from goals.case_studies.minimal.world.world_top import w_top
from logic.patterns.robotic_movement import OrderedVisit, StrictOrderedVisit

...
from synthesis.controller import Controller, ControllerSpec
from synthesis.world import World

from goals.context import Context
from contracts.contract import Contract
from goals.tools.names import generate_goal_id
from goals.tools.strings import tab
...
class Goal:
    ...
    def __le__(self: Goal, other: Goal):
        from goals.goal.operations.refinement import g_refinement

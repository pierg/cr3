...
from logic.specification import and_
from logic.specification.rules_extractors import extract_mutex_rules, extract_adjacency_rules
from logic.specification.string_logic import implies_
from logic.specification.temporal import LTL
from logic.typelement.basic import BooleanUncontrollable, BooleanControllable
from logic.typeset import Typeset
from synthesis.controller.tools import strix_syntax_fix

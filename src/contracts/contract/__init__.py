...
from contracts.contract.conflicts_manager import find_inconsistencies_operation
...
class Contract:
    ...
    def is_consistent(self) -> bool:
        return self.guarantees.is_satisfiable

    @property
    def is_compatible(self) -> bool:
        return self.assumptions.is_satisfiable
